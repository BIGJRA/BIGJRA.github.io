    ...
    for i in 0...VISIBLEMOVES
      ...
      if moveobject
        ...
        if movedata
          ...
          textpos.push([PBMoves.getName(moveobject),80,yPos,0, Color.new(248,248,248),Color.new(0,0,0)])
          if movedata.totalpp>0
            textpos.push([_INTL("PP"),112,yPos+32,0, Color.new(64,64,64),Color.new(176,176,176)])
            textpos.push([_ISPRINTF("{1:d}/{2:d}", movedata.totalpp,movedata.totalpp),230,yPos+32,1, Color.new(64,64,64),Color.new(176,176,176)])
          end
        else
