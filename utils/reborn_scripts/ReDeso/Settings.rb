...
#===============================================================================
MAXIMUMLEVEL       = 150  # Set to 200 for postgame, should be locked to 100 for pregame
EGGINITIALLEVEL    = 1
...
#===============================================================================
=begin
but who the fuck would even use this amirite
RIVALNAMES = [
   [:RIVAL1,12],
   [:RIVAL2,12],
   [:CHAMPION,12]
...
RoamingSpecies = [
   {species: :RAYQUAZA, level: 130, switch: 1870, type: 0, variable: 698, caughtswitch: 1871, roamgraphic: "Graphics/Pictures/rayquazaMarker" }
]
...
SHINY_WILD_POKEMON_SWITCH = 261
FATEFUL_ENCOUNTER_SWITCH  = 262
NO_MONEY_LOSS             = 789
