...
REBORN_THEME_TEAMS = [
  ...
  { number: 1, trainer: "Julia", name: "Responsible Workplace Practices", teamnumber: 14, field: :FACTORY, doubles: true },
  ...
  { number: 3, trainer: "Shelly", name: "Computational Science Isn't So Hard!", teamnumber: 15, field: :GLITCH, doubles: false },
  ...
  { number: 8, trainer: "Radomus", name: "Celestial Enlightenment", teamnumber: 15, field: :ASHENBEACH, doubles: false },
  ...
  { number: 12, trainer: "Terra", name: "THE ENTIRE CIRCUS!!!!11!!!!1!!!", teamnumber: 15, field: :BIGTOP, doubles: false },
  ...
  { number: 15, trainer: "Titania", name: "Forty Nights of Fire", teamnumber: 14, field: :CORROSIVEMIST, doubles: true },
  ...
  { number: 19, trainer: "Heather", name: "Polar Peak Princess", teamnumber: 10, field: :SNOWYMOUNTAIN, doubles: false },
  ...
  { number: 27, trainer: "Bennett", name: "Predisposition to Showmanship", teamnumber: 11, field: :BIGTOP, doubles: false },
  ...
  { number: 34, trainer: "Ace of All Suits", name: "Myth and Mystery", teamnumber: 10, field: :FAIRYTALE, doubles: false },
  { number: 34, trainer: "Ace of All Suits", name: "Eyes of Fire", teamnumber: 11, field: :BURNING, doubles: false },
  { number: 34, trainer: "Ace of All Suits", name: "Half-Tossed Coin", teamnumber: 12, field: :DARKCRYSTALCAVERN, doubles: false },
  { number: 34, trainer: "Ace of All Suits", name: "Technological Trickster", teamnumber: 13, field: :GLITCH, doubles: false },
